...
Compares v1 (baseline), v2 (stream_wait_value32), v3 (NVLS multicast + CE),
v4 (pairwise sync + multi-stream CE), and v5 (in-kernel multimem.st) across
a sweep of shard sizes at a fixed world size. v3 and v5 require multicast
...
def _build_variant(
    ...
    """
    if op_name in ("_low_contention_all_gather_v3", "_low_contention_all_gather_v5"):
